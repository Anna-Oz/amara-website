      ...
      <div className="relative h-full flex items-center justify-center text-center text-white px-4">
        ...
        >
          <h1 className="font-cormorant text-5xl md:text-7xl mb-4">
            Your Dream Mediterranean Wedding Awaits
          </h1>
          <p className="font-montserrat text-lg md:text-xl mb-8 max-w-2xl mx-auto">
            Creating Unforgettable Moments in Fethiye's Paradise
          </p>
          <motion.button
